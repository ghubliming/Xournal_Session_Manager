...
2. **Handle64**: Already included in this repository.

## Setup & Usage
1. Clone this repository or download the files.
2. Run `launch.bat` to start the manager.
3. **Save Session**: Choose option `1` before closing your computer or Xournal++.
4. **Restore Session**: Choose option `2` after a restart to pick up where you left off.
